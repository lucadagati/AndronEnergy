...
const podPlantStruct_1 = require("./podPlantStruct");
...
let PlantOperations = class PlantOperations extends contractExtension_1.ContractExtension {
    ...
    async CreatePlant(ctx, param) {
        ...
        const plant = new podPlantStruct_1.PodPlantStruct(params.plantId, params.podId, params.generatedEnergy);
...
//# sourceMappingURL=podPlantCrud.js.map